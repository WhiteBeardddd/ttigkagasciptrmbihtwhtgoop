...
# Filled by setup() from boss MELEE_DATA["bullet"] — do not edit here
...
func setup(
	...
	bullet_knockback = p_bullet_knockback
...
func _shoot_from(point: CollisionShape2D) -> void:
	...
	# Pass damage straight from boss MELEE_DATA
